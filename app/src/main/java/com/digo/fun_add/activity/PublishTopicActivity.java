...
import com.digo.fun_add.presenter.PublishTopicPresenter;
...
public class PublishTopicActivity extends BaseActivity<PublishTopicPresenter> implements PublishTopicView {
    ...
    //"添加图片"标签TextView
    @Bind(R.id.tv_publish_topic_add_photo)
    TextView mAddPhotoTextView;
    //RecycleView
    @Bind(R.id.recycleview_publish_topic)
    ...
    public BasePresenterInfc getPresenter() {
        return new PublishTopicPresenter(this,new PublishTopicModel());
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.ry_start_time:
                imm.hideSoftInputFromWindow(mEtTopicName.getWindowToken(), 0);
